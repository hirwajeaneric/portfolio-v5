...
export const metadata = {
  ...
  keywords:
    "Jean Eric Hirwa, Blog, Software Development, Web Development, Technology, Programming",
  openGraph: {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-start w-full scroll-smooth bg-zinc-900">
        <section
          id="process"
          className="max-w-screen-xl flex flex-col mx-auto justify-center items-center pt-40 md:pt-48 pb-16 md:pb-32 w-full px-4"
        >
              ...
              <Suspense fallback={<CardSkeleton />} key={article.id}>
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    <p className="text-zinc-300">{new Date(article.createdAt).toDateString()}</p>
                    <h1 className="text-2xl text-zinc-300">{article.title}</h1>
                    <p className="text-zinc-300">{article.introduction}</p>
                  </div>
                  <span className="text-zinc-300 py-1 uppercase text-sm w-fit px-2 border border-zinc-600 bg-zinc-700">
